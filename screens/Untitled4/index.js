...
const Untitled4 = () => {
  return <View style={_styles.FNiDYXtZ}>
      <View style={_styles.BGgjFrzs}></View><Text style={_styles.chMqcsJA}>Lorem ipsum…</Text><ImageBackground style={_styles.JfFcSPqE} source={{
