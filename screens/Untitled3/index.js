...
const Untitled3 = () => {
  return <View style={_styles.ZJBToVbP}>
      <View style={_styles.YuvQibnY}></View><ImageBackground style={_styles.eteVyHlk} source={{
    ...
    }} resizeMode="cover"></ImageBackground><Text style={_styles.nGjsmBRT}>Lorem ipsum…</Text></View>;
};
